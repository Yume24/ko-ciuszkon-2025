    ...
    return (
        <div className="h-screen bg-cover bg-center flex flex-col" style={{ backgroundImage: "url('/background.png')" }}>
            ...
            <main className="flex-1 flex flex-col items-center justify-center text-white px-4">
                ...
                <p className="mt-6 text-xl md:text-2xl text-center max-w-2xl" style={{textShadow: '2px 2px 2px black'}}>
                    Dołącz do naszej misji ochrony środowiska poprzez edukację i działanie.
                </p>
                <button className="mt-10 px-8 py-4 bg-[var(--hunter-green)] hover:bg-[var(--asparagus)] text-white font-bold text-lg rounded-full shadow-lg transition-all duration-300">
                    Zacznij teraz
                </button>
            </main>
        </div>
